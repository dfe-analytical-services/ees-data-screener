...
# If you are having issues with pandoc, run the following two lines. These will check your version and automatically update it for you.
# This may take a couple of minutes, and will download it for you and automatically start the install wizard.
# Follow the instructions for the install, restart RStudio, and then run these again, it will let you know if your version is 2.7.3 or later.

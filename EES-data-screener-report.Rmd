...
## Time validation
 **Checking that the time_period is either 4 or 6 digits** `r pass_fail(time_period_result)`
```{r time_period, echo=FALSE,warning=FALSE,comment=NA}
time_period(dataset)
```

 **Checking that if the time_period is 6 digits that they show consecutive years** `r pass_fail(time_period_six_result)`

...
if (reading_option == 2) {
  dataset <- read_csv(dataset_path, trim_ws = FALSE)
  metadata <- read_csv(metadata_path, trim_ws = FALSE)
  metadata_utf16 <- read.csv(metadata_path, stringsAsFactors = FALSE, encoding = "UTF-16")
}
...
`r if(reading_option==2){paste(your_meta_file)}else{paste(your_data_file,".meta.csv",sep="")}` `r if(meta_percent == "100%"){knitr::include_graphics("images/checked.png")}else{knitr::include_graphics("images/cancel.png")}` 
<br><br>

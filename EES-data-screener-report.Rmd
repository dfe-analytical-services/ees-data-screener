...
output:
  govdown::govdown_document:
    ...
    logo_text: "DfE"
    font: "sans-serif"
    title: "Underlying data screening"
    phase: alpha
---
...
library(govdown)
```
## Data report summary{caption="Your publication name"}

### **Files tested**{caption=`r Sys.Date()`}
...
```{r files, include=FALSE, results='hide', warning=FALSE, message=FALSE}
...
:::{.warning}
 If you have any questions about this report contact cameron.race@education.gov.uk.
:::
:::
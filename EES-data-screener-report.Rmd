...
Tests failed: `r fail`
<br>
`r if(advisory==0) {} else {if(advisory>0) {paste("Recommendations: ",advisory," - please check the tests for recommended changes to your files.")}}`
...
`r if(data_advisory==0) {} else {if(data_advisory>0) {include_graphics("images/advisory.png")}}`
**`r if(data_advisory==0) {} else {if(data_advisory>0) {paste("Please check the recommended changes to your data file.")}}`**
...
`r if(meta_advisory==0) {} else {if(meta_advisory>0) {include_graphics("images/advisory.png")}}` 
**`r if(meta_advisory==0) {} else {if(meta_advisory>0) {paste("Please check the recommended changes to your metadata file.")}}`**

...
meta_data <- paste("data_metadata/", your_meta_file, ".meta.csv", sep = "")
...
<center>
`r if(total_percent == "100%"){knitr::include_graphics("images/checked.png")}else{knitr::include_graphics("images/cancel.png")}`
</center>
...
`r paste(your_meta_file,".meta.csv",sep="")` `r if(meta_percent=="100%"){knitr::include_graphics("images/checked.png")}else{knitr::include_graphics("images/cancel.png")}` 
<br><br>

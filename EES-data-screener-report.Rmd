...
<br>
Overall: `r total_percent` of tests passed.
<br>
Data file: `r data_percent` of tests passed.
<br>
Meta file: `r meta_percent` of tests passed.
...
<br><br>
r data_percent of tests passed.
...
<br>
r meta_percent of tests passed.
...
```{r results_calculator,echo=FALSE,results='hide'}

...
```{r results_total, echo=FALSE, comment=NA, ref.label="results_calculator"}
message(paste(total_percent," of standards met"), "the thing should be in here")
```
...
pass <- sum(all_results == TRUE)
fail <- sum(all_results ==FALSE)
  
total_percent <- paste((pass/pass+fail)*100,"%")

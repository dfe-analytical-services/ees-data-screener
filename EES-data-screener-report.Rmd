...
dataset <- read_csv("data_metadata/All_geographies_messy.csv",trim_ws = FALSE)
metadata <- read_csv("data_metadata/all_geographies_messy.meta.csv",trim_ws = FALSE)
```
...
```{r geography_level_completed,echo=FALSE,comment=NA}
 ...
 **Checking that filter and filter group have been entered the right way around in the metadata based on the levels present in each**
